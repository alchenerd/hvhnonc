...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(648, 536)
        self.verticalLayout = QtWidgets.QVBoxLayout(Dialog)
        self.verticalLayout.setObjectName("verticalLayout")
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.rb6 = QtWidgets.QRadioButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.rb6.setFont(font)
        self.rb6.setObjectName("rb6")
        self.gridLayout.addWidget(self.rb6, 1, 2, 1, 1)
        self.rb9 = QtWidgets.QRadioButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.rb9.setFont(font)
        self.rb9.setObjectName("rb9")
        self.gridLayout.addWidget(self.rb9, 2, 2, 1, 1)
        self.rb8 = QtWidgets.QRadioButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.rb8.setFont(font)
        self.rb8.setObjectName("rb8")
        self.gridLayout.addWidget(self.rb8, 2, 1, 1, 1)
        ...
        self.rb5 = QtWidgets.QRadioButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.rb5.setFont(font)
        self.rb5.setObjectName("rb5")
        self.gridLayout.addWidget(self.rb5, 1, 1, 1, 1)
        ...
        self.rb7 = QtWidgets.QRadioButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.rb7.setFont(font)
        self.rb7.setObjectName("rb7")
        self.gridLayout.addWidget(self.rb7, 2, 0, 1, 1)
        self.rb10 = QtWidgets.QRadioButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.rb10.setFont(font)
        self.rb10.setObjectName("rb10")
        self.gridLayout.addWidget(self.rb10, 3, 0, 1, 1)
        self.rb11 = QtWidgets.QRadioButton(Dialog)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.rb11.setFont(font)
        self.rb11.setObjectName("rb11")
        self.gridLayout.addWidget(self.rb11, 3, 1, 1, 1)
        ...
        self.row_per_page = QtWidgets.QSpinBox(Dialog)
        self.row_per_page.setMinimumSize(QtCore.QSize(100, 0))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(16)
        self.row_per_page.setFont(font)
        self.row_per_page.setProperty("value", 20)
        self.row_per_page.setObjectName("row_per_page")
        self.horizontalLayout_3.addWidget(self.row_per_page, 0, QtCore.Qt.AlignHCenter)
        ...
        Dialog.setTabOrder(self.rb4, self.rb5)
        Dialog.setTabOrder(self.rb5, self.rb6)
        Dialog.setTabOrder(self.rb6, self.rb7)
        Dialog.setTabOrder(self.rb7, self.rb8)
        Dialog.setTabOrder(self.rb8, self.rb9)
        Dialog.setTabOrder(self.rb9, self.rb10)
        Dialog.setTabOrder(self.rb10, self.rb11)
        Dialog.setTabOrder(self.rb11, self.purchase_date_chk)
        ...
        Dialog.setTabOrder(self.keeper, self.row_per_page)
        Dialog.setTabOrder(self.row_per_page, self.quitBtn)
        ...
        Dialog.setTabOrder(self.previewBtn, self.printBtn)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "列印報表"))
        self.rb6.setText(_translate("Dialog", "[增加單]"))
        self.rb9.setText(_translate("Dialog", "盤點紀錄"))
        self.rb8.setText(_translate("Dialog", "動產標籤"))
        self.rb4.setText(_translate("Dialog", "[除帳]減損單"))
        self.rb5.setText(_translate("Dialog", "動產財產卡"))
        ...
        self.rb7.setText(_translate("Dialog", "[增減表]"))
        self.rb10.setText(_translate("Dialog", "盤存表"))
        self.rb11.setText(_translate("Dialog", "財產保管卡"))
        ...
        self.label_14.setText(_translate("Dialog", "每頁列印筆數："))
        self.quitBtn.setText(_translate("Dialog", "離開"))
        self.changeDefaultPrinterBtn.setText(_translate("Dialog", "變更預設引表機"))
        self.previewBtn.setText(_translate("Dialog", "預覽"))
        self.printBtn.setText(_translate("Dialog", "列印"))
